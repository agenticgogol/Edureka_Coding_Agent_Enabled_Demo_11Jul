...
description: Use to add a new step or feature to an existing teaching demo. Clarifies and paraphrases before touching files, then appends without disturbing prior steps.
---
