...
description: Use when the user wants to start a new end-to-end project but only has a rough idea, not a written project_brief.md. Interviews the user and drafts a project brief.
---
