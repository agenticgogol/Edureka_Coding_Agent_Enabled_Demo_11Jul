...
Codex's task plan gets seeded from when building. See `../../WORKFLOW.md`
for the full skill/role sequence table this template is derived from.
...
4. Mirror `plan.md` into Codex's task plan before building, so progress is
   visible.
