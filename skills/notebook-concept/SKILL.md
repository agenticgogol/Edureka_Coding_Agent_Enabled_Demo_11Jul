...
description: Use when building a concept demo as a Jupyter notebook. Generates one atomic-concept notebook following this repo's 7-part teaching contract.
---
...
AGENTS.md notebook contract, and violating it is the #1 quality problem
